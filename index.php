...
<body>
  ...
  <div class="page-wrap">
    <div class="header">
      <div class="box-1">
        <h1 disabled>Bank Sampah SEKAWAN</h1>
    ...
    <section class="team">
      <div class="container">
        <div class="row">
          ...
          <p>Bank sampah Sekawan berlokasi di RW 04, Karangasem, Laweyan, Surakarta. Selain bidang bank sampah kami juga berfokus pada pengelolaan sampah, seperti komposting berbasis sampah, kerajinan berbahan baku sampah, dan masih banyak lagi program yang kami kembangkan. Saat ini bank sampah Sekawan melayani warga RW 04 Karangasem yang berjumlah lebih dari 100 kepala keluarga Hal itu menunjukan bahwa warga masyarakat RW 04 Karangasem sangat antusias dengan adanya program ini, dan tentu bank sampah bisa mendapatkan perhatian khusus dari warga sekitar. Jika Anda berminat untuk bergabung, silahkan ikuti langkah berikut ini.</p>
        </div>
  ...
  <div id="bar">
    <div class="row mgt50px">
      ...
      <br>
      <br>
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d247.20000823518785!2d110.78278185891277!3d-7.553143892284157!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a144096c090e5%3A0xbbd569d8f8d9b432!2sCQWM%2BP4C%2C%20Jl.%20Sawo%20III%2C%20Karangasem%2C%20Kec.%20Laweyan%2C%20Kota%20Surakarta%2C%20Jawa%20Tengah%2057145!5e0!3m2!1sid!2sid!4v1686199579776!5m2!1sid!2sid"  width="1362" height="470" frameborder="0" style="margin-bottom: 0; left: 10px;" allowfullscreen></iframe>
    </div>
  </div>
  ...
  <footer class="footer-distributed">
    ...
    <div class="footer-center">
      ...
      <div>
        ...
        <p><span>Desa Karangasem</span> Kecamatan Laweyan, Kota Surakarta.</p>
      </div>

      <div>
        <i class="fa fa-phone"></i>
        <p><a href="sms:(+62)85694587999">(+62)812 3456 7890</a></p>
      </div>

      <div>
        <i class="fa fa-envelope"></i>
        <p><a href="mailto:Official_bsk09@gmail.com">banksampah_sekawan@gmail.com</a></p>
      </div>
    ...
    <div class="footer-right">
      ...
      <p class="footer-company-about">
        ...
        Untuk yang ingin lebih dekat dengan Bank Sampah SEKAWAN, silahkan kunjungi sosial media kami dibawah ini!
      </p>
